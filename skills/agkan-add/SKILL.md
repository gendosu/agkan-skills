...
Use the environment's user-question tool, or ask directly in conversation, to collect missing fields together within the tool's limits. Include Title, Body, Tags, Priority, Parent, and Branch as needed.
